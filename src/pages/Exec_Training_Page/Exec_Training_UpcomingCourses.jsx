import { posts } from "../../data/siteData"
  ...
  export default function Exec_Training_UpcomingCourses() {
    return (
      <div className="bg-white py-24 sm:py-32 border-t">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"> Upcoming Executive TrainingCourses</h2>
